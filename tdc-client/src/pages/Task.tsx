...
import { _createTask, _updateTask, _deleteTask, _taskList } from "../components/task/task.service";
import { _getCorrespondanceBySubject } from "../components/correspondance/service";
import { _getAllBrands } from "../components/brand/brand.service";
import type { Task, CreateTaskDto } from "../components/task/task.types";
...
export function TaskManager() {
  ...
  const handleBrandChange = (value: string) => {
    console.log("handleBrandChange", value, value.length);
