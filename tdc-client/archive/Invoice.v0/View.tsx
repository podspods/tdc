...
export default function View({ ...props }: ViewProps) {
  ...
  useEffect(() => {
    if (props.invoiceState === ComponentStatus.ToPdf) {
      generatePdf();
    }
  }, [props.invoiceState]);
  ...
  const generatePdf = async () => {
    ...
    props.onStateChange(ComponentStatus.View, props.invoiceInfo.id);
  };
  //--------------------------------------------------------------------------------------------------------------------------
  ...
  return (
    <>
      <p>
        [{props.invoiceState}] [{ComponentStatus.ToPdf}]
      </p>
      {props.invoiceState === ComponentStatus.ToPdf && null}
